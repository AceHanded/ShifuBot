...
class Basic(commands.Cog):
    ...
    @discord.option(name="subsection", description="The subsection of the help command",
                    choices=["Basic", "Music", "Admin", "Game", "Economy", "Voice"], required=False)
    async def help(self, ctx: discord.ApplicationContext, subsection: str = None):
        ...
        help_msgs = {
            "Basic": "**/help {subsection}** - Simple help command\n"
                     ...
                     "**/generate [type_] [prompt] {temperature} {image_scale} {engine}** - Generate text or images "
                     "using OpenAI\n"
            ...
            "Music": "**/connect** - Invites the bot to the voice channel\n\n"
                     ...
                     "**/play [query] {insert} {pre_shuffle} {ignore_live} {start_at}** - Adds and plays songs in the "
                     "queue\n"
                     ...
                     "**/view {from_} {to} {seek} {previous}** - Displays songs in queue, with the ability to seek "
                     "them\n"
                     ...
                     "\\* **from_** - The start position of the queue removal, or positions separated by semicolons "
                     "(i.e. pos1;pos2;...)\n"
                     ...
                     "\\* **from_** - The current position of the song in queue\n\\* **to** - The position in queue "
                     "you wish to move the song to\n"
                     ...
                     "for the queue",
            "Admin": "**/msgdel [amount]** - Deletes the specified amount of messages in a channel\n"
                     ...
                     "**/settings {speech_recognition} {language}** - Modifies guild-specific settings\n"
                     "\\* **speech_recognition** - Enables speech recognition, by toggling the microphone on / off in "
                     "quick succession\n"
                     "\\* **language** - Specifies the speech recognition language in IETF format (i.e. en-US, "
                     "fi-FI, ...)",
            ...
            "Economy": "**/register** - Create an account\n\n"
                       ...
                       "**/leaderboard {from_} {to}** - Displays the richest users in the guild\n"
                       "\\* **from_** - The start position of the leaderboard display\n\\* **to** - The end position "
                       "of the leaderboard display",
            "Voice": "**play | toista {query}** - Adds and plays songs in the queue\n"
